...
module.exports = class Logica {
  ...
  getSensores(callback) {
    ...
    let sql = 'SELECT Sensores.idSensor, TipoSensor.descripcion, SensoresUsuarios.idUsuario FROM Sensores, TipoSensor, SensoresUsuarios WHERE  Sensores.idSensor=SensoresUsuarios.idSensor AND Sensores.idTipoSensor=TipoSensor.idTipoSensor;'
